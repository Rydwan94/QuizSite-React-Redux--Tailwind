...
const Features = () => {
  ...
  return (
    <section id="features" className="relative pt-96 pb-40">
      ...
      <div
      ref={ref}
        className={`max-container flex justify-center flex-wrap gap-9 max-lg:px-4 ${
          isInView && "animate-fade-right animate-delay-600"
        }`}
      >
        <div className="min-w-[300px] flex-1 shadow-xl p-4 rounded-xl">
          ...
          <p className="text-lg font-monsterrat text-slate-400 leading-8 ">
            3 dimensional coverage of all questions related to a perticular
            topic
          </p>
        </div>
        <div className="min-w-[300px] flex-1 shadow-xl p-4 rounded-xl">
          <img src={boxIcon} alt="boxIcon" />
          <h3 className="py-4 font-allerta text-2xl font-bold">
            Plenty of subjescts
          </h3>
          <p className="text-lg font-monsterrat text-slate-400 leading-8 ">
        ...
        <div className="min-w-[300px] flex-1 shadow-xl p-4 rounded-xl">
          ...
          <p className="text-lg font-monsterrat text-slate-400 leading-8 ">
            Detailed explaination of a solution is provided to get depper
